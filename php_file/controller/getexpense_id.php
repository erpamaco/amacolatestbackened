...
$stmt =$admin->ret("SELECT dl.paid_to,dl.amount,dl.id,dt.name,dl.payment_account_id,dl.referrence_bill_no,dl.created_at FROM `expenses` as dl inner join `payment_accounts` as dt on dl.payment_account_id=dt.id");
